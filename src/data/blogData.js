export const blogData = [
  {
    ...
    data: '28/01/2026',
    conteudo: `
      <p>A Evolutec, referência em ensino profissionalizante, acaba de anunciar a abertura de vagas para mais de 100 cursos em diversas áreas de atuação para o ano de 2026.</p>
      <p>Com o mercado de trabalho cada vez mais competitivo, a qualificação profissional tornou-se um diferencial indispensável. Pensando nisso, a instituição preparou condições especiais e facilitadas para quem deseja dar o primeiro passo rumo a uma nova carreira ou se especializar ainda mais.</p>
      <h3>Cursos em Alta</h3>
      <p>Entre as opções disponíveis, destacam-se cursos nas áreas de Tecnologia, Saúde, Administração e Estética, setores que apresentam alta demanda por profissionais qualificados.</p>
      <p>Não perca essa oportunidade de transformar o seu futuro. As matrículas já estão abertas e as vagas são limitadas!</p>
    `,
    destaque: true
  },
  {
    id: 'aniversario-castanhal',
    imagem: 'https://images.unsplash.com/photo-1523580494863-6f3031224c94?w=300&h=200&fit=crop',
    tags: ['#EVENTOS', '#CASTANHAL'],
    titulo: 'Aniversario de Castanhal',
    subtitulo: 'Comemoração especial na unidade de Castanhal.',
    data: '28/01/2026',
    conteudo: `
      <p>Neste mês, celebramos o aniversário da nossa querida cidade de Castanhal com muita alegria e orgulho de fazer parte dessa história.</p>
      <p>A unidade da Evolutec em Castanhal preparou uma programação especial para os alunos e para a comunidade, com palestras gratuitas, workshops e sorteios de bolsas de estudo.</p>
      <p>Agradecemos a todos que confiam em nosso trabalho e nos ajudam a construir um futuro melhor através da educação.</p>
    `,
    destaque: false
  },
  {
