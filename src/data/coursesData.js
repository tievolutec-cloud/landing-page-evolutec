export const cursosData = [
  {
    ...
    category: "Saude",
    image: "https://images.unsplash.com/photo-1587854692152-cbe660dbde88?w=900&h=600&fit=crop",
    mode: "Presencial",
    duration: "Ate 12 meses",
    hours: "Sob consulta",
    tag: "Profissionalizante",
    description:
      "Formacao para atendimento em farmacias e drogarias, com foco em rotina pratica e postura profissional.",
    fullDescription:
      "O curso de Atendente de Farmacia da Evolutec prepara voce para atuar diretamente no atendimento ao publico em farmacias e drogarias. Durante a formacao, voce aprende organizacao de medicamentos, leitura basica de receitas, tecnicas de atendimento e rotinas do ambiente farmaceutico, alem de desenvolver comunicacao, responsabilidade e agilidade.",
    objectives: [
      "Capacitar para atendimento profissional em farmacias",
      "Ensinar organizacao e controle de medicamentos",
      "Desenvolver comunicacao e postura no atendimento",
      "Preparar para leitura basica de receitas medicas",
      "Formar profissionais prontos para o mercado de trabalho"
    ],
    curriculum: [
      {
  ...
  },
  {
    ...
    tag: "Profissionalizante",
    description:
      "Curso para atuar na base administrativa das empresas, com foco em organizacao, atendimento e suporte interno.",
    fullDescription:
      "O curso de Auxiliar Administrativo da Evolutec prepara voce para atuar na area administrativa de empresas. O aluno aprende organizacao de documentos, atendimento ao cliente, rotinas financeiras e comunicacao profissional, com desenvolvimento pessoal e profissional para o primeiro emprego.",
    objectives: [
      "Preparar para atuar em rotinas administrativas reais",
      "Desenvolver organizacao e produtividade",
      "Ensinar atendimento profissional ao cliente",
      "Capacitar para atividades financeiras basicas",
      "Formar profissionais prontos para o primeiro emprego"
    ],
    curriculum: [
      {
        module: "Conteudos da Formacao",
  ...
  {
    id: 3,
    slug: "desenvolvedor-de-games-e-apps",
    title: "Desenvolvedor de Games e Apps",
    category: "Tecnologia",
    ...
    tag: "Profissionalizante",
    description:
      "Formacao para criar jogos e aplicativos do zero, com programacao, criatividade e projetos praticos.",
    fullDescription:
      "O curso de Desenvolvedor de Games e Apps da Evolutec foi criado para quem quer entrar no universo da tecnologia criando jogos e aplicativos. Durante a formacao, o aluno aprende fundamentos de programacao, desenvolvimento de games e aplicativos mobile, estimulando raciocinio logico e resolucao de problemas.",
    objectives: [
      "Ensinar logica de programacao do zero",
      "Desenvolver games e aplicativos na pratica",
      "Estimular raciocinio logico e criatividade",
      "Preparar para o mercado de tecnologia",
      "Criar base para carreira como desenvolvedor"
    ],
    curriculum: [
      {
        module: "Conteudos da Formacao",
  ...
  },
  {
    ...
    tag: "Profissionalizante",
    description:
      "Curso para lideranca e organizacao de equipes, com foco em RH, produtividade e comunicacao.",
    fullDescription:
      "O curso de Gerenciamento de Pessoas da Evolutec prepara voce para atuar na gestao e organizacao de equipes. O aluno aprende rotinas de RH, departamento pessoal, comportamento organizacional e competencias de lideranca para crescer profissionalmente.",
    objectives: [
      "Capacitar para atuar na gestao de pessoas",
      "Desenvolver habilidades de lideranca e comunicacao",
      "Ensinar rotinas de departamento pessoal",
      "Melhorar produtividade e organizacao no trabalho",
      "Preparar para crescimento profissional"
    ],
    curriculum: [
      {
        module: "Conteudos da Formacao",
    ...
    careerOpportunities: [
      ...
      "Escritorios e consultorias",
      "Industrias e comercios",
      "Instituicoes publicas e privadas"
    ],
    requirements: "Nao informado",
    certificationType: "Profissionalizante",
  ...
  },
  {
    ...
    title: "Gestao Empresarial",
    category: "Gestao",
    image: "https://images.unsplash.com/photo-1507679799987-c73779587ccf?w=900&h=600&fit=crop",
    mode: "Presencial",
    duration: "Ate 12 meses",
    hours: "Sob consulta",
    tag: "Profissionalizante",
    description:
      "Formacao completa para quem quer atuar em gestao, administrativo e financeiro com visao estrategica.",
    fullDescription:
      "O curso de Gestao Empresarial da Evolutec prepara voce para entender como uma empresa funciona na pratica. O aluno aprende recursos humanos, contabilidade, comunicacao empresarial, organizacao de processos e tomada de decisao, com foco em crescimento profissional e empreendedorismo.",
    objectives: [
      "Ensinar como funciona a gestao de uma empresa",
      "Desenvolver visao estrategica e organizacional",
      "Capacitar para areas administrativas e financeiras",
      "Preparar para crescimento profissional ou empreendedorismo",
      "Desenvolver habilidades de comunicacao e lideranca"
    ],
    curriculum: [
      {
        module: "Conteudos da Formacao",
    ...
    careerOpportunities: [
      ...
      "Negocios proprios",
      "Industrias, comercios e servicos"
    ],
    requirements: "Nao informado",
    certificationType: "Profissionalizante",
  ...
  },
  {
    ...
    tag: "Profissionalizante",
    description:
      "Curso para atuar com atendimento ao publico em hotelaria, turismo, recepcao e eventos.",
    fullDescription:
      "O curso de Hotelaria e Turismo da Evolutec prepara voce para atendimento ao publico em turismo, hospedagem e recepcao. Durante a formacao, o aluno aprende rotinas praticas de hoteis e estabelecimentos turisticos, desenvolvendo comunicacao, postura e organizacao.",
    objectives: [
      "Capacitar para atendimento no setor de turismo e hotelaria",
      "Desenvolver comunicacao e postura profissional",
      "Ensinar rotinas de recepcao e atendimento",
      "Preparar para trabalhar com o publico",
      "Formar profissionais prontos para o mercado"
    ],
    curriculum: [
      {
        module: "Conteudos da Formacao",
    ...
    careerOpportunities: [
      ...
      "Agencias de turismo",
      "Empresas de eventos",
      "Recepcoes e atendimentos em geral",
      "Aeroportos e rodoviarias"
    ],
    requirements: "Nao informado",
    certificationType: "Profissionalizante",
    salary: "A partir de R$ 1.400",
  ...
  },
  {
    ...
    tag: "Profissionalizante",
    description:
      "Formacao para aprender computador do zero e dominar ferramentas essenciais para o mercado.",
    fullDescription:
      "O curso de Informatica Completa da Evolutec e ideal para quem quer aprender do zero a usar o computador e as principais ferramentas exigidas no mercado. O aluno desenvolve habilidades em Word, Excel, PowerPoint, internet, organizacao de arquivos e operacao de sistemas.",
    objectives: [
      "Ensinar informatica do zero",
      "Capacitar para uso profissional do computador",
      "Desenvolver produtividade no dia a dia",
      "Preparar para exigencias do mercado de trabalho",
      "Aumentar as chances de conseguir emprego"
    ],
    curriculum: [
      {
        module: "Conteudos da Formacao",
    ...
    careerOpportunities: [
      ...
      "Atendimento",
      "Funcoes operacionais com uso de computador",
      "Primeiro emprego em areas que exigem informatica"
    ],
    requirements: "Nao informado",
    certificationType: "Profissionalizante",
    salary: "A partir de R$ 1.400",
  ...
  },
  {
    ...
    title: "Manutencao de Celulares",
    category: "Tecnologia",
    image: "https://images.unsplash.com/photo-1601784551446-20c9e07cdbdb?w=900&h=600&fit=crop",
    mode: "Presencial",
    duration: "Ate 12 meses",
    hours: "Sob consulta",
    tag: "Profissionalizante",
    description:
      "Curso tecnico para reparos em dispositivos moveis, com foco em diagnostico e pratica de manutencao.",
    fullDescription:
      "O curso de Manutencao de Celulares da Evolutec prepara voce para entender e realizar reparos basicos e intermediarios em dispositivos moveis. O aluno aprende hardware, identificacao de problemas, manutencao de equipamentos e nocoes de seguranca digital.",
    objectives: [
      "Ensinar fundamentos de manutencao de dispositivos",
      "Desenvolver habilidades tecnicas basicas",
      "Preparar para atuar com suporte e reparos",
      "Estimular raciocinio tecnico",
      "Criar base para atuacao na area de tecnologia"
    ],
    curriculum: [
      {
        module: "Conteudos da Formacao",
  ...
  },
  {
    ...
    category: "Marketing",
    image: "https://images.unsplash.com/photo-1533750516457-a7f992034fec?w=900&h=600&fit=crop",
    mode: "Presencial",
    duration: "Ate 12 meses",
    hours: "Sob consulta",
    tag: "Profissionalizante",
    description:
      "Aprenda estrategias de divulgacao, vendas e posicionamento de marcas no ambiente digital.",
    fullDescription:
      "O curso de Marketing Digital da Evolutec prepara voce para atuar com estrategias reais de divulgacao online. O aluno aprende criacao de conteudo, trafego pago e ferramentas de marketing para atrair clientes e fortalecer marcas na internet.",
    objectives: [
      "Ensinar estrategias de marketing digital",
      "Desenvolver habilidades de divulgacao online",
      "Capacitar para criacao de conteudo",
      "Introduzir trafego pago",
      "Preparar para atuacao no mercado digital"
    ],
    curriculum: [
      {
        module: "Conteudos da Formacao",
  ...
  },
  {
    ...
    tag: "Profissionalizante",
    description:
      "Curso para atuacao no varejo com operacao de caixa, pagamentos e atendimento profissional.",
    fullDescription:
      "O curso de Operador de Caixa da Evolutec prepara voce para atendimento ao cliente e operacao de caixa em diversos estabelecimentos comerciais. O aluno aprende abertura e fechamento de caixa, registro de produtos, meios de pagamento e comunicacao no atendimento.",
    objectives: [
      "Ensinar operacao de caixa na pratica",
      "Desenvolver atendimento ao cliente",
      "Capacitar para lidar com pagamentos",
      "Preparar para o primeiro emprego",
      "Desenvolver agilidade e organizacao"
    ],
    curriculum: [
      {
        module: "Conteudos da Formacao",
  ...
  },
  {
    ...
    tag: "Profissionalizante",
    description:
      "Formacao para analise de dados e criacao de dashboards interativos com uma das ferramentas mais usadas do mercado.",
    fullDescription:
      "O curso de Power BI da Evolutec prepara voce para analise de dados e criacao de relatorios profissionais. O aluno aprende a transformar dados em informacoes visuais para apoiar decisoes empresariais com dashboards interativos.",
    objectives: [
      "Ensinar analise de dados na pratica",
      "Desenvolver relatorios e dashboards",
      "Capacitar para uso do Power BI",
      "Melhorar tomada de decisoes com dados",
      "Preparar para atuacao na area de dados"
    ],
    curriculum: [
      {
        module: "Conteudos da Formacao",
  ...
  },
  {
    ...
    title: "Designer",
    category: "Design",
    image: "https://images.unsplash.com/photo-1581291518633-83b4ebd1d83e?w=900&h=600&fit=crop",
    mode: "Presencial",
    duration: "Ate 12 meses",
    hours: "Sob consulta",
    tag: "Profissionalizante",
    description:
      "Curso para criacao de artes profissionais com foco em redes sociais, identidade visual e mercado criativo.",
    fullDescription:
      "O curso de Designer da Evolutec prepara voce para criar artes profissionais para redes sociais, empresas e projetos pessoais. Durante a formacao, o aluno aprende identidade visual, edicao de imagens e criacao de materiais graficos como posts, banners e logotipos.",
    objectives: [
      "Ensinar criacao de artes profissionais",
      "Desenvolver identidade visual",
      "Capacitar para uso de ferramentas de design",
      "Preparar para o mercado criativo",
      "Estimular criatividade e visao estetica"
    ],
    curriculum: [
      {
        module: "Conteudos da Formacao",
  ...
  {
    id: 13,
    slug: "profissional-em-animacao-3d",
    title: "Profissional em Animacao 3D",
    category: "Design",
    image: "https://images.unsplash.com/photo-1617791160505-6f00504e3519?w=900&h=600&fit=crop",
    mode: "Presencial",
    duration: "Ate 12 meses",
    hours: "Sob consulta",
    tag: "Profissionalizante",
    description:
      "Formacao para modelagem e criacao de projetos tridimensionais para arquitetura, design e publicidade.",
    fullDescription:
      "O curso de Profissional em Animacao 3D da Evolutec prepara voce para criar projetos tridimensionais com foco em modelagem, visualizacao e criacao de ambientes. O aluno aprende ferramentas de mercado para desenvolver objetos e cenarios completos.",
    objectives: [
      "Ensinar modelagem e criacao em 3D",
      "Desenvolver projetos visuais",
      "Capacitar no uso de ferramentas profissionais",
      "Estimular criatividade e visao espacial",
      "Preparar para o mercado criativo"
    ],
    curriculum: [
      {
  ...
  {
    id: 14,
    slug: "operador-de-caixa-formacao-completa",
    title: "Operador de Caixa (Formacao Completa)",
    category: "Comercio",
    image: "https://images.unsplash.com/photo-1556740738-b6a63e27c4df?w=900&h=600&fit=crop",
    mode: "Presencial",
    duration: "Ate 12 meses",
    hours: "Sob consulta",
    tag: "Profissionalizante",
    description:
      "Formacao completa para operacao de caixa com atendimento e informatica basica aplicada ao trabalho.",
    fullDescription:
      "O curso de Operador de Caixa (Formacao Completa) da Evolutec prepara voce para atuar com seguranca e profissionalismo no atendimento e operacao de caixa, incluindo informatica basica para organizacao de informacoes e comunicacao profissional.",
    objectives: [
      "Ensinar operacao de caixa com seguranca",
      "Desenvolver atendimento profissional",
      "Capacitar para uso basico de informatica",
      "Preparar para o primeiro emprego",
      "Aumentar as chances de contratacao"
    ],
    curriculum: [
      {
        module: "Conteudos da Formacao",
  ...
  {
    id: 15,
    slug: "profissional-em-planilhas",
    ...
    tag: "Profissionalizante",
    description:
      "Curso para dominar Excel e planilhas digitais, com foco em organizacao, calculos e analise de dados.",
    fullDescription:
      "O curso de Profissional em Planilhas da Evolutec prepara voce para trabalhar com controle de informacoes, calculos e analise de dados usando Excel e planilhas digitais. O aluno aprende do basico ao avancado, com aplicacao direta no ambiente de trabalho.",
    objectives: [
      "Ensinar uso completo de planilhas",
      "Desenvolver organizacao e controle de dados",
      "Capacitar para calculos e analises",
    ...
    careerOpportunities: [
      ...
      "Escritorios e contabilidade",
      "Industrias e comercios",
      "Qualquer empresa que trabalhe com dados"
    ],
    requirements: "Nao informado",
    certificationType: "Profissionalizante",
    salary: "A partir de R$ 1.800",
  ...
  },
  {
    ...
    tag: "Profissionalizante",
    description:
      "Formacao tecnica para instalacao, configuracao e manutencao de redes e infraestrutura de TI.",
    fullDescription:
      "O curso de Redes e Infraestrutura da Evolutec prepara voce para atuar com instalacao, configuracao e manutencao de redes de computadores. O aluno aprende cabeamento, seguranca digital e fundamentos de infraestrutura para atuar na area de TI.",
    objectives: [
      "Ensinar fundamentos de redes de computadores",
      "Capacitar para instalacao e manutencao",
      "Desenvolver conhecimento em infraestrutura",
      "Preparar para atuacao em TI",
      "Criar base para crescimento na area tecnologica"
    ],
    curriculum: [
      {
        module: "Conteudos da Formacao",
  ...
  },
  {
    ...
    tag: "Profissionalizante",
    description:
      "Curso introdutorio para quem quer comecar no mundo digital com base em informatica, internet e logica.",
    fullDescription:
      "O curso de Tecnologia da Evolutec oferece uma formacao introdutoria para quem deseja entrar no mundo digital, com foco em informatica basica, internet, ferramentas tecnicas e nocoes de logica. E ideal para quem esta comecando do zero.",
    objectives: [
      "Ensinar fundamentos da tecnologia",
      "Desenvolver habilidades digitais basicas",
      "Preparar para o uso do computador",
      "Criar base para outras areas",
      "Aumentar oportunidades no mercado"
    ],
    curriculum: [
      {
        module: "Conteudos da Formacao",
    ...
    careerOpportunities: [
      "Aplicacao em ambiente de trabalho em geral",
      "Base para cursos avancados",
      "Uso pessoal e produtividade",
      "Qualificacao profissional inicial"
    ],
    requirements: "Nao informado",
    certificationType: "Profissionalizante",
    salary: "Base para ampliar oportunidades",
    marketInfo:
      "Mais de 80% das vagas exigem conhecimentos basicos em informatica. Habilidades digitais aumentam significativamente as oportunidades profissionais."
  }
];
...
export const getCourseById = (id) => {
  return cursosData.find((curso) => curso.id === parseInt(id, 10));
};
