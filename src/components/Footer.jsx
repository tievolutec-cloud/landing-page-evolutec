...
function Footer() {
  ...
  const [telefoneWhatsApp] = useState('(91) 4042-4250');
      ...
      <div className="footer-container">
        ...
        <div className="footer-col footer-col--brand">
          ...
          <div className="footer-sociais">
            ...
            <a href={socialLinks.tiktok} target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="footer-social-link">
              <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
